...
- Enforce a single canonical URL shape (host + no trailing slash) by redirecting trailing-slash HTML routes to the non-trailing version to avoid duplicate canonical warnings.
