  ...
  },
  {
    ...
    render: () => (
      <>
        ...
        <div className="space-y-3 p-4 text-sm">
          <div className="flex gap-2">
            <button className="rounded-md border bg-background px-4 py-3 min-h-[44px] min-w-[44px]" aria-label="Like this"><ThumbsUp className="w-5 h-5" /></button>
            <button className="rounded-md border bg-background px-4 py-3 min-h-[44px] min-w-[44px]" aria-label="Dislike this"><ThumbsDown className="w-5 h-5" /></button>
          </div>
          <textarea
            className="h-20 rounded-md border bg-background px-3 py-2"
