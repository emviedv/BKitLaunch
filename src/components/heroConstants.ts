...
/**
 * @deprecated Use <Button variant="hero-primary"> instead.
 * Removed in Phase 4 of UI Component Consolidation.
 */
// HERO_PRIMARY_BUTTON_CLASS - removed, use Button variant="hero-primary"

/**
 * @deprecated Use <Button variant="hero-secondary"> instead.
 * Removed in Phase 4 of UI Component Consolidation.
 */
// HERO_SECONDARY_BUTTON_CLASS - removed, use Button variant="hero-secondary"
